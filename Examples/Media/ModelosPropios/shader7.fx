...
VS_OUTPUT1 vertexShaderEspecularDifusaAmbiente (VS_INPUT input1)
{
   ...
   output1.ColorEspecular=float4 (spec,0);
...
float4 pixelShaderEspecular (float4 especul:COLOR0,float4 dif: COLOR1,float2 tex0:TEXCOORD):COLOR  //,float3 ambiente:TEXCOORD1
{
   float3 texColor=tex2D (muestra1,tex0).rgb;
