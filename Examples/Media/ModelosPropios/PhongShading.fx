...
float fSpecularPower = 26.84;				// exponente de la luz specular
...
VS_OUTPUT vs_main( VS_INPUT Input )
{
   ...
   Output.Norm = normalize(mul(Input.Normal,matWorldViewProj));
...
{      
	...
	float3 D = normalize(float3(Pos.x,Pos.y,Pos.z)-fvEyePosition.xyz);
